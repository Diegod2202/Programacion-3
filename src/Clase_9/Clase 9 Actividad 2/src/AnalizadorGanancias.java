...
public class AnalizadorGanancias {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Ingrese el símbolo de la acción a analizar: ");
            String simboloSeleccionado = scanner.nextLine().toUpperCase();
            scanner.close();
            
            if (!datos.containsKey(simboloSeleccionado)) {
                System.out.println("No hay datos disponibles para la acción: " + simboloSeleccionado);
                return;
            }
            
            int[] precios = datos.get(simboloSeleccionado).stream().mapToInt(i -> i).toArray();
            ...
            System.out.println("La ganancia máxima posible para " + simboloSeleccionado + " es: " + gananciaMaxima);
